...
struct SectorEditorUiState {
    ...
    engine::UIFloatInputState lightProxyHaloOffsetXInput;
    engine::UIFloatInputState lightProxyHaloOffsetYInput;
    engine::UIFloatInputState lightProxyHaloOffsetZInput;
    ...
    engine::UIFloatInputState lightProxyShaftOffsetXInput;
    engine::UIFloatInputState lightProxyShaftOffsetYInput;
    engine::UIFloatInputState lightProxyShaftOffsetZInput;
