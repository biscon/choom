...
| Phase 6: Integrate Facade Cleanup | Planned |  | `SectorMeshPreview` delegates door preparation, drawing, shadow caster access, debug counters, and shutdown to the helper. |
