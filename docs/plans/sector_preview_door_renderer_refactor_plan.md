...
| Phase 4: Move Main Scene Door Draw Path | Planned |  | Move main-scene door rendering while preserving draw order, object-probe uploads, dynamic lighting/shadows, and render-state restore. |
