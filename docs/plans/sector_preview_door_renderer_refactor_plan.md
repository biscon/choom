...
| Phase 5: Move Door Shadow Caster Drawing Integration | Planned |  | Let dynamic spotlight shadow rendering draw prepared door meshes through the door renderer boundary. |
